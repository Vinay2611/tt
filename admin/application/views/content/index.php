        ...
        <div class="col-md-12">
            ...
            <div id="panel-1" class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="pull-right"><a href="<?php echo base_url();?>content/add" class="btn btn-sm btn-success">Add Content Page</a></div>
                        ...
                        <?php if(isset($data)){
                            foreach ($data as $d){
                                ...
                                <tr class="odd gradeX">
                                    ...
                                    <td><a href="add?id=<?php echo $d["id"];?>" class="btn btn-xs btn-success"><i class="fa fa-edit"></i></a></td>
                                </tr>
                                <?php
                            }
                        }?>
